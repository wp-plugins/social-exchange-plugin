jQuery(document).ready(function(){
	...
	jQuery(".campaign-btn").live("click",function(){
		...
		if(activate == 'no'){
			...
			jQuery("#sxen_"+id).find(".sx-pause-inactive").removeClass("sx-pause-inactive").addClass("sx-pause-active");						jQuery("#sxlnw_"+id).show();
						jQuery("#sxlndw_"+id).hide();						jQuery("#sxen_"+id).find(".sx-play-inactive").attr("title","Campaign is stopped");						jQuery("#sxen_"+id).find(".sx-pause-inactive").removeAttr("title" ); 
		}else{ 
			...
			jQuery("#sxen_"+id).find(".sx-pause-active").removeClass("sx-pause-active").addClass("sx-pause-inactive");						jQuery("#sxen_"+id).find(".sx-play-inactive").removeAttr("title" );						jQuery("#sxen_"+id).find(".sx-pause-inactive").attr("title","Campaign is running");
		}
